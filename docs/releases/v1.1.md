# HookLine v1.1 — Hardening & DX

## Highlights

- **Backpressure & overload protection**: 413 on payloads > 512 KB, 429 + `Retry-After` when queue exceeds `HL_MAX_QUEUE_DEPTH`
...
- **Grafana dashboard**: `grafana/dashboards/hookline.json` — 11 panels covering throughput, latency, DLQ, SSE, and more
...
| `HL_MAX_QUEUE_DEPTH` | `100000` | Per-tenant queue depth before 429 |
| `HL_MAX_INFLIGHT_GLOBAL` | `500` | Global in-flight delivery cap |
| `HL_COMPACTION_INTERVAL_SECS` | `3600` | Segment compaction frequency |
