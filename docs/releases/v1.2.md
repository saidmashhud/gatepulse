# HookLine v1.2 — Streaming 1.0 + Inbox UX
...
- **Stream metrics**: `hookline_stream_clients` gauge and `hookline_stream_events_sent_total` counter
...
|----------|---------|-------------|
| `HL_STREAM_BACKFILL_MAX_EVENTS` | `10000` | Max events to replay on reconnect |
| `HL_STREAM_BACKFILL_MAX_AGE_DAYS` | `7` | Max age of events for backfill |
