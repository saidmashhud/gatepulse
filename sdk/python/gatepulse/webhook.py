"""GatePulse webhook verification helpers.
...
def verify_webhook(
    ...
    """Verify a GatePulse webhook request and return the parsed event.

    Args:
        body:    Raw request body (bytes or str).
        headers: Request headers (case-insensitive dict is fine).
        secret:  Endpoint secret configured in GatePulse.
...
def make_flask_handler(secret: str, on_event):
    ...
    Usage:
        ...
        from gatepulse.webhook import make_flask_handler
    ...
    _handler.__name__ = "gatepulse_webhook"
    return _handler
...
def make_fastapi_handler(secret: str, on_event):
    ...
    Usage:
        ...
        from gatepulse.webhook import make_fastapi_handler
