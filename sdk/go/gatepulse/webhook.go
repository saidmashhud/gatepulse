...
// WebhookEvent is a verified, parsed GatePulse event received at your webhook endpoint.
...
//	    event, err := gatepulse.VerifyWebhook(body, r.Header, os.Getenv("WEBHOOK_SECRET"))
//	    if err != nil {
...
// Example:
//
//	http.HandleFunc("/webhook", gatepulse.WebhookHandlerFunc(
//	    os.Getenv("WEBHOOK_SECRET"),
//	    func(event *gatepulse.WebhookEvent) error {
